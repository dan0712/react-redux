					...
					<div className="row">
						...
						<div className="col-md-6">
							<div className="form-group">
								...
								<DateTimeField placeholder="" ref="time" inputFormat="MM-DD-YYYY"
								               inputProps={{id: "toDate", name: "toDate" }}/>
							</div>
						</div>
					</div>

					<button onClick={handleSubmit} data-dismiss="modal" className="btn btn-wide btn-success margin-right-15">Save changes</button>
